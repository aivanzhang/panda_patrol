...
def generate_data_tests(
    ...
    Note this only works if you have an account at [URL].
    ...
    if patrol_url == DEFAULT_PANDA_PATROL_URL and not secret_key.startswith("public-"):
        ...
        print(
            "You are not using the default panda patrol url or you are using a public key. You will not be able to generate data tests. Create an account at [URL] to generate data tests."
        )
