...
def run_patrol(group_name: str, context: PatrolContext, dbt_model_uri=None):
        ...
        try:
            ...
            def data_test_wrapper(**kwargs):
                ...
                if "patrol_id" in function_parameters:
                    return context["func"](patrol_id=context["patrol_dict"], **kwargs)
                else:
    ...
    if dbt_model_uri:
        try:
            ...
            patrol_code = extract_function_source(file_path, context["func"].__name__)
        except:
            pass
